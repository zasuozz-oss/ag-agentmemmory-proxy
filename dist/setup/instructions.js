...
async function resolveTemplate(relative) {
...
async function upsertBlock(filePath, content) {
...
export function antigravityInstructionsPath(home = os.homedir()) {
    return path.join(home, '.gemini', 'GEMINI.md');
}
export async function installAntigravityInstructions() {
